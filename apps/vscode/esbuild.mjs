...
function copyMedia() {
  ...
  copyFileSync(codicons + "codicon.css", "media/codicon.css");
  copyFileSync(codicons + "codicon.ttf", "media/codicon.ttf");
  copyFileSync(require.resolve("@npm-manager/assets/main.css"), "media/main.css");
}
...
/** @type {import('esbuild').BuildOptions} */
const webviewConfig = {
  entryPoints: [require.resolve("@npm-manager/webview-ui")],
  bundle: true,
  format: "iife",
  platform: "browser",
  target: "es2020",
